  ...
  <div class="flex items-center gap-2 wrapper">
    <div class="flex flex-col min-[890px]:flex-row items-center gap-4 min-[600px]:gap-[40px] min-[890px]:gap-[105px] relative w-full">
      ...
      <div class="flex-1 overflow-hidden relative h-[131px] md:h-auto">
        <div class="absolute -top-4 left-[-7%] w-[189px] lg:hidden h-[200px] bg-white z-20 blur-[16px]"></div>
        <div class="absolute -top-4 right-[-5%] w-[189px] h-[200px] lg:hidden bg-white z-20  blur-[16px]"></div>
