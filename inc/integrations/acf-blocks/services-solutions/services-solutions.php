...
<?php if (have_rows('services_solutions')) :  while (have_rows('services_solutions')) : the_row(); ?>
        <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> solutions-tabs-slider px-4  md:px-10 py-[60px] md:py-[120px] flex justify-center">
            <div class="w-full flex items-center flex-col max-w-[1920px]">
                ...
                <?php if (have_rows('main_content')) :  while (have_rows('main_content')) : the_row(); ?>
                        ...
                        <div class="solutions-tab-content">
                            ...
                            <div class="solutions-content-inner w-full ">
                                <?php if (have_rows('service_group')) :  while (have_rows('service_group')) : the_row(); ?>
...
<style>
    /* ═══════════════════════════════════════════════════════════
   Desktop slider visibility  (.solutions-sliders container)
   ═══════════════════════════════════════════════════════════ */
.solutions-sliders .solutions-slider {
  display: none;
}
.solutions-sliders .solutions-slider.is-active {
  display: block;
}

/* ═══════════════════════════════════════════════════════════
   Mobile columns visibility  (.solutions-content-inner container)
   ═══════════════════════════════════════════════════════════ */
.solutions-content-inner .solutions-columns {
  display: none;
}
.solutions-content-inner .solutions-columns.is-active {
  display: block;
}


/* ═══════════════════════════════════════════════════════════
   Equal-column GRID MODE  (desktop, lg+)
   JS adds .solutions-grid + data-cols="n" to .solutions-track
   when card count ≤ SLIDER_THRESHOLD
   ═══════════════════════════════════════════════════════════ */
.solutions-track.solutions-grid {
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
  width: 100%;
...
.solutions-track.solutions-grid .solution-card {
  flex: 1 1 0;
  min-width: 0;
  max-width: 100%;
}
...
/* 1 card → 100% */
.solutions-track.solutions-grid[data-cols="1"] .solution-card {
  flex: 0 0 100%;
}

/* 2 cards → 50 / 50 */
.solutions-track.solutions-grid[data-cols="2"] .solution-card {
  flex: 0 0 calc(50% - 10px);
}

/* 3 cards → 33 / 33 / 33 */
.solutions-track.solutions-grid[data-cols="3"] .solution-card {
  flex: 0 0 calc(33.333% - 14px);
}

/* 4 cards → 25 / 25 / 25 / 25 */
.solutions-track.solutions-grid[data-cols="4"] .solution-card {
