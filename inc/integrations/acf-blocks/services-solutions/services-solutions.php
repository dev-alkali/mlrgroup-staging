                ...
                <?php if (have_rows('header_content')) :  while (have_rows('header_content')) : the_row(); ?>
                        ...
                        <div class="solutions-header flex flex-col md:flex-row w-full mb-8 md:mb-[60px] gap-3">
                            ...
                            <h2 class="solutions-header__title text-[clamp(36px,5vw,48px)] leading-[clamp(44px,5.1vw,60px)] tracking-[-2%] font-heading text-neutral-800 md:min-w-[360px] lg:min-w-[515px]">
                                ...
                                <span class="font-bold text-neutral-800"><?= wp_kses_post(get_sub_field('title_light')) ?></span>
                            </h2>                                
                            <?php endif; ?>
                                                ...
                                                <?php foreach ($selected_services as $service_post) : ?>
                                                    ...
                                                    <a class="solution-card max-lg:max-w-[400px]" href="<?= esc_url($card_link) ?>">
                                                        <div class="flex flex-col w-full items-start gap-[15px] relative height-set">
                                                            ...
                                                            <?php endif; ?>
                                                            <div class="flex flex-col w-[371px] justify-between items-start gap-4 relative flex-[0_0_auto] max-w-[100%]">
                                                    ...
                                                    <a href="<?= esc_url($card_link) ?>" class="solution-card  max-w-[400px]">
                                                        <div class="flex flex-col w-full items-start gap-[15px] relative height-set">
                                                            <?php if (!empty($card_image)) : ?>
                                                                <img class="self-stretch w-full h-[330px] object-cover" src="<?= esc_url($card_image) ?>" alt="<?= esc_attr($card_title) ?>">
                                                            <?php endif; ?>
                                                            <div class="flex flex-col w-full justify-between max-w-[358px] md:max-w-[371px] items-start gap-4 relative flex-[0_0_auto]">
                                                                <div class="flex flex-col items-start gap-[8px] relative self-stretch w-full flex-[0_0_auto]">
                                                                    <div class="relative self-stretch font-heading font-bold text-[#262626] text-[24px] leading-[32px] tracking-[-0.02em]">
                                                                        <?= esc_html($card_title) ?>
                                                                    </div>
                                                        ...
                                                        <a href="<?= esc_url($card_link) ?>" class="solution-card  max-w-[400px]">
                                                            <div class="flex flex-col w-full items-start gap-[15px] relative height-set">
                                                                <?php if (!empty($card_image)) : ?>
                                                                    <img class="self-stretch w-full h-[330px] object-cover" src="<?= esc_url($card_image) ?>" alt="<?= esc_attr(wp_strip_all_tags($card_title)) ?>">
                                                                <?php endif; ?>
                                                                <div class="flex flex-col justify-between w-full max-w-[358px] md:max-w-[371px] items-start gap-4 relative flex-[0_0_auto]">
                                                                    <div class="flex flex-col items-start gap-[8px] relative self-stretch w-full flex-[0_0_auto]">
                                                                        <div class="relative self-stretch font-heading font-bold text-[#262626] text-[24px] leading-[32px] tracking-[-0.02em]">
                                                                            <?= wp_kses_post($card_title) ?>
                                                                        </div>
