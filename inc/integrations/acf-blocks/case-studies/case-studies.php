  ...
  "' : ""; ?>>
    ...
    switch ($item_count) {
        case 1:
            ...
            break;
        case 2:
            $grid_class = 'grid max-[1024px]:grid-cols-1 min-[1024px]:grid-cols-2 gap-5';
            break;
        case 3:
            $grid_class = 'grid max-[1024px]:grid-cols-1 min-[1024px]:grid-cols-2 min-[1024px]:grid-rows-2 gap-5';
            break;
        case 4:
            $grid_class = 'grid max-[600px]:grid-cols-1 min-[600px]:grid-cols-2 min-[600px]:grid-rows-2 gap-5';
            break;
        case 5:
        default:
