...
<?php if (have_rows('case_studies')) :  while (have_rows('case_studies')) : the_row(); ?>
    ...
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> case-studies-sec flex justify-center px-4 md:px-10 py-[60px] lg:py-[80px] xl:py-[120px] bg-white">
