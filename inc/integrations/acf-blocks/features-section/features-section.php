...
?>
  <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> our-values-sec px-4 md:px-10 py-[60px] lg:py-[80px] xl:py-[120px] overflow-hidden <?php echo $bg_color_class; ?><?php echo $pt_class; ?><?php echo $pb_class; ?>">
	  ...
	  <?php if($title_row_1 || $title_row_2 ): ?>
			<div class="w-full wrapper lg:mb-[70px] sm:mb-[30px] mb-[20px] overflow-visible">
				<?php if($title_row_1 || $title_row_2): ?>
				...
				<?php foreach($lists as $list): 
					...
					<div class="flex flex-row md:gap-[20px] gap-[16px] <?php echo $width_class; ?>">
						<div class="flex flex-col flex-1 border-b border-[#FC4438] pb-[25px] relative">
							...
							<img class="w-4 md:w-[23px] md:h-[23px] absolute right-0 bottom-[-1px] border-b border-[#FFFFFF]" src="<?= get_template_directory_uri() ?>/assets/imgs/red-arrow-feature-sec.svg" alt="arrow">
						</div>
					</div>
				<?php endforeach; ?>
			</div>
