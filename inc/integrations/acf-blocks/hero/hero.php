            ...
            <div class="flex flex-col items-start justify-center gap-10 w-full">
              <div class="flex flex-col items-start justify-center gap-5 w-full">
                <?php if (have_rows('title_group')) : while (have_rows('title_group')) : the_row(); ?>
                  ...
                  <?php if (have_rows('titles_row_1_change') || !empty($title_row_2)) : ?>
                    <h1 class="c-hero__title max-w-[936px] font-bold text-[44px] md:text-[64px] min-[767px]:text-[70px] min-[1200px]:text-[90px] text-white font-heading anim" data-delay="0.1" data-anim="up">
                      <?php if (have_rows('titles_row_1_change')) : ?>
                        <span class="flex items-center">
                          <?php $is_first = true; ?>
                          <?php while (have_rows('titles_row_1_change')) : the_row();
              ...
              if (!empty($btn_path) && !empty($btn_label)) :
              ?>
