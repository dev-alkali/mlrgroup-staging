...
<?php if (have_rows('brands')) : while (have_rows('brands')) : the_row(); ?>
  ...
  <section class="c-brands py-[40px]">
    <div class="wrapper flex flex-col lg:flex-row items-center gap-[20px] min-[1280px]:gap-[105px] w-full ">
      ...
      <?php if (!empty($images)) : ?>
        <div class="flex-1 overflow-hidden  relative h-[91.15px] md:h-auto">
          ...
          <div class="absolute -top-4 right-[-100px] w-[133px] h-[139px] max-[890px]:hidden bg-white z-20  blur-[16px]"></div>
