...
<?php if (have_rows('hero')) :  while (have_rows('hero')) : the_row(); ?>
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> flex flex-col w-full items-center p-0 min-[890px]:pt-5 min-[890px]:pb-0  min-[890px]:px-5 bg-white h-screen">
      <?php if (have_rows('main')) :  while (have_rows('main')) : the_row(); ?>
          <div
            class="max-w-[1920px] flex-1  w-full" style="
                  ...
                  <div class="flex flex-col items-start justify-center gap-10 w-full ">
                    <div class="flex flex-col items-start justify-center gap-5 w-full">
                      <?php if (have_rows('title_group')) : while (have_rows('title_group')) : the_row(); ?>
                          <h1 class="max-w-[936px] font-bold text-[44px] min-[600px]:text-[64px] min-[767px]:text-[70px] min-[1200px]:text-[90px] tracking-[-2%] leading-[56px] min-[600px]:leading-[60px] min-[767px]:leading-[76px] min-[1200px]:leading-[106px] text-white font-heading">
                      ...
                      <p class="max-w-[800px] text-[18px] min-[600px]:text-xl leading-[26px] min-[600px]:leading-7 text-gray-50 font-body">
