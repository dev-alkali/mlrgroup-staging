    ...
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> client-logos flex justify-center px-4 md:px-10 py-[60px] lg:py-[80px] xl:py-[120px]<?php echo $pt_class; ?><?php echo $pb_class; ?>">
      <div class="w-full wrapper">
        ...
        <div class="logo-cards gap-2 flex justify-center flex-wrap">
          ...
          ?>
            <div class="logo-card p-6 flex items-center text-center justify-center aspect-square relative lg:w-[calc(20%-6px)] sm:w-[calc(33.33%-6px)] w-[calc(50%-6px)]"
              ...
              <?php if ($logo) : ?>
                <img
                  ...
                  class="max-w-[22px] md:max-w-[28px] lg:max-w-[39px] xl:max-w-[52px] xl:max-h-[39px] object-contain h-auto"
                />
              <?php endif; ?>
            </div>
          <?php endforeach; ?>
