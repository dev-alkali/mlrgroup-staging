...
?>
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> test two-col-sec px-4 md:px-10 py-[60px] lg:py-[80px] xl:py-[120px] <?php echo $bg_color_class; ?><?php echo $pt_class; ?><?php echo $pb_class; ?>">
      
      <div class="gap-[30px] w-full wrapper flex flex-col md:flex-row two-column-wrapper">
