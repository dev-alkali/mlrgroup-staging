...
<?php if (have_rows('case_studies_grid')) :  while (have_rows('case_studies_grid')) : the_row(); ?>
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> flex justify-center pt-20 px-0 bg-white">    
        ...
        <div class="w-full flex flex-col items-start justify-center gap-5 px-4 sm:px-10">            
            <h2 class="flex flex-col max-w-[512px] font-heading text-white tracking-[-0.02em] text-[clamp(36px,5vw,68px)] leading-[clamp(44px,6vw,78px)]">
                    ...
                    <a href="<?php echo esc_url(get_sub_field('item_path')); ?>"
                       ...
                       style="
                        ...
                        <div class="gradient-box flex flex-col items-start justify-end gap-2 px-3 sm:px-6 py-4 sm:py-7 h-full">
                            <div clas="cs-card__logo">
                                <?php echo get_sub_field('logo_image'); ?>
                            </div>
