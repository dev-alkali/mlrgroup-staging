    ...
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> two-col-sec px-4 md:px-10 py-[60px] md:py-[120px]">
      <div class="wrapper flex flex-col gap-[60px]">
        <div class="top-title-sec flex flex-wrap">
          <div class="top_title basis-[40%] max-md:w-full md:pr-[20px]">
          ...
          <?php if($description): ?>
            <div class="basis-[60%] max-md:w-full md:pl-[20px]"><p class="font-body font-normal text-[18px] leading-[26px] tracking-[0em] text-[#525252]"><?php echo $description; ?></p></div>
          <?php endif; ?>
        </div>
