...
?>
    <section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> two-col-sec <?php echo $bgclassName; ?> px-4 md:px-10 py-[60px] lg:py-[80px] xl:py-[120px]">
...
<?php if (have_rows('partnership_list')) : ?>
  ...
  <div class="partnership-list flex flex-wrap min-[1199px]:flex-nowrap justify-center gap-6">
    ...
    ?>
      ...
      <div class="flex flex-col gap-[20px] justify-between min-[1199px]:w-[20%] sm:w-[calc(33.33%-16px)] min-[575px]:w-[calc(50%-12px)]">
        ...
        <!-- Image -->
        <?php if ($image) : ?>
          <figure class="md:aspect-[256/340] sm:aspect-[358/380] min-[575px]:aspect-[358/300] aspect-[358/380]">
            <img 
