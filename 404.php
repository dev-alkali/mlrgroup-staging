	...
	<main id="primary" class="site-main">
		...
		<section class="error-404 not-found wrapper lg:py-[200px] md:py-[140px] py-[80px]">
			...
			<div class="flex relative items-center justify-center">
				<div class="absolute top-0 left-0 w-full h-full bg-cover bg-center bg-repeat-x img-position-left" style="background-image: url('<?= get_template_directory_uri() ?>/assets/imgs/404-arrow-imgs-3.svg');"></div>
				<div class="absolute top-0 left-0 w-full h-full bg-cover bg-center bg-repeat-x img-position-right" style="background-image: url('<?= get_template_directory_uri() ?>/assets/imgs/404-arrow-imgs-3.svg');"></div>
			...
			<div class="flex relative items-center justify-center">
				<div class="absolute top-0 left-0 w-full h-full bg-cover bg-center bg-repeat-x img-position-left" style="background-image: url('<?= get_template_directory_uri() ?>/assets/imgs/404-arrow-imgs-04.svg');"></div>
				<div class="absolute top-0 left-0 w-full h-full bg-cover bg-center bg-repeat-x img-position-right" style="background-image: url('<?= get_template_directory_uri() ?>/assets/imgs/404-arrow-imgs-04.svg');"></div>
