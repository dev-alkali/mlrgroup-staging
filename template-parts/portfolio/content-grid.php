            ...
            ?>
                    <article class="gallery-card group">
                        <div class="card-image-wrap relative overflow-hidden aspect-[333.33/360] w-full" style="background-image: url('<?= esc_url($image_url); ?>'); background-position: 50% 50%; background-size: cover; background-repeat: no-repeat;">
                            ...
                            <div class="card-overlay absolute inset-0 [background:linear-gradient(312deg,rgba(0,0,0,0.82)_0%,rgba(253,67,56,0.82)_100%)] opacity-0 group-hover:opacity-100 group-focus:opacity-100 group-active:opacity-100  md:transition-opacity md:duration-300 flex flex-col items-center justify-center gap-2 px-6">
