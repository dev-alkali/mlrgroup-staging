                    ...
                    <article class="gallery-card group">
                        <div class="card-image-wrap relative overflow-hidden aspect-[333.33/360] w-full" style="background-image: url('<?= esc_url($image_url); ?>'); background-position: 50% 50%; background-size: cover; background-repeat: no-repeat;">
                            <div class="card-overlay absolute inset-0 [background:linear-gradient(312deg,rgba(0,0,0,0.82)_0%,rgba(253,67,56,0.82)_100%)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-2 px-6 flex flex-col">
                                <button type="button" item-id="<?= esc_attr($post_id); ?>" class="view-inquery bg-black flex items-center justify-center gap-2 p-[16px] w-full rounded-[30px] cursor-pointer border-0 hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors translate-y-3 card-btn-transition max-w-[262px]">
                                    <span class="font-heading font-medium flex items-center justify-center  text-white text-xs md:text-sm tracking-[0] leading-5 whitespace-nowrap"><img class="h-[14px] w-[14px] mt-[-1px] mr-[8px]" src="<?= esc_url(get_template_directory_uri() . '/assets/imgs/magnifying.svg'); ?>" alt=""> <span class="hidden md:inline-block">QUICK VIEW</span></span>
                                </button>
                                <button type="button" item-id="<?= esc_attr($post_id); ?>" class="add-inquiry bg-white flex items-center justify-center gap-2 p-[16px] w-full rounded-[30px] cursor-pointer border-0 hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#262626] transition-colors translate-y-3 card-btn-transition  max-w-[262px]">
                                    <span class="font-heading font-semibold flex justify-center items-center text-neutral-800 text-xs md:text-sm tracking-[0] leading-5 whitespace-nowrap"><img class="h-[14.3px] w-[14.3px] mt-[-2px] mr-[8px]" src="<?= esc_url(get_template_directory_uri() . '/assets/imgs/plus-black.svg'); ?>" alt=""> <span class="hidden md:inline-block">ADD TO INQUIRY LIST</span></span>
                                </button>
                            </div>
                        </div>
                    </article>
