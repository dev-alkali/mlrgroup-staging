<?php
    ...
    $title_row_1 = get_field('title_row_1', 'option');
    $title_row_2 = get_field('title_row_2', 'option');
...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> flex c-cta w-full bg-black py-12 md:py-17 xl:py-25 px-6 md:px-12">
  ...
  <div class="c-cta__wrap flex flex-col align-center w-full gap-[40px] max-w-[1220px]">
    ...
    <?php if( have_rows('cta_items', 'option') ): ?>
      <div class="c-cta__buttons-wrap flex flex-col gap-[22px] max-w-[277px]">
        <?php while( have_rows('cta_items', 'option') ): the_row(); ?>
