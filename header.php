...
<header class=" <?php echo $header_schema.' '.get_field('header_schema'); ?> z-[99] w-full site-header anim px-4 min-[600px]:px-10 min-[767px]:px-20 lg:px-[100px]" data-delay="" data-anim="up" data-start="top 100%">
