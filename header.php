...
<header class=" <?php echo $header_schema.' '.get_field('header_schema'); ?> z-50 w-full site-header anim px-10 min-[767px]:px-[100px]" data-delay="2.25" data-anim="up" data-start="top 100%">
