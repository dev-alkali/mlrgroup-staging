...
<header class=" <?php echo $header_schema.' '.get_field('header_schema'); ?> z-[99] w-full site-header is-visible px-4 min-[600px]:px-10 min-[767px]:px-20 lg:px-[100px]" data-delay="" data-anim="up" data-start="top 100%">
              ...
              <div class="site-nav__item relative <?php echo $has_children ? 'has-children' : ''; ?>">
                ...
                <?php if ($has_children): ?>
                  <div class="site-nav__dropdown min-[1180px]:absolute min-[1180px]:left-0 min-[1180px]:top-full min-[1180px]:bg-white min-[1180px]:px-[20px] min-[1180px]:py-[28px] min-[1180px]:shadow-lg">
                    ...
                    ?>
                      <a class="site-nav__dropdown-link block py-2 font-medium font-heading leading-[22px] <?php echo esc_attr($child_active_class); ?>"
