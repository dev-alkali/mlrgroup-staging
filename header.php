...
?>
<header class=" <?php echo $header_schema.' '.get_field('header_schema'); ?> z-[99] w-full site-header ani is-visible px-4 md:px-10" data-delay="" data-anim="" data-start="">  
  <?php
  ...
  <div class="hidden min-[1180px]:flex self-stretch flex-[0_0_auto] w-full wrapper">
    ...
    <!-- LOGO -->
      ...
      <div class="site-header__nav inline-flex items-center gap-5 min-[1350px]:gap-10 flex-[0_0_auto]">
              ...
              <div class="site-nav__item relative <?php echo $has_children ? 'has-children' : ''; ?>">
                ...
                <?php if ($has_children): ?>
                  <div class="site-nav__dropdown min-[1180px]:absolute min-[1180px]:left-0 min-[1180px]:top-full min-[1180px]:bg-white min-[1180px]:px-[20px] min-[1180px]:py-[28px] min-[1180px]:shadow-lg">
                    ...
                    ?>
                      <a class="site-nav__dropdown-link block py-2 font-medium font-heading leading-[22px] whitespace-nowrap <?php echo esc_attr($child_active_class); ?>"
        ...
        <a class="btn-primary " href="<?php echo esc_url(get_field('lets_talk_link', 'option')); ?>"><span>Let’s TALK</span> <img decoding="async" class="relative w-[14px] h-[14px] mt-[-3px] max-[768px]:mt-[3px] arrow" src="/wp-content/themes/Mlrgroup/assets/imgs/Arrow.svg" alt="arrow"></a>
        <?php endif; ?>
